...
// *
// */
//public class LocalTrainedCoRef implements ACoRef {
//
...
//		LocalTrainedCoRef coref = new LocalTrainedCoRef(CCM2Constants.NERGold, CCM2Constants.ACE05RelExModelPath + "/GoldMentions.save");
...
//			List<Constituent> annots = ta.getTa().getView(coref.getName()).getConstituents();
...
//	 */
//	public LocalTrainedCoRef(String nerView, String modelPath) throws IOException, ClassNotFoundException {
...
//	}
//	
//	public LocalTrainedCoRef(AMentionDetector md, String modelPath) throws ClassNotFoundException, IOException {
//		this.md = md;
//		this.NAME = "RelEx_" + md.getName();
//		model = SLModel.loadModel(modelPath);
//	}
