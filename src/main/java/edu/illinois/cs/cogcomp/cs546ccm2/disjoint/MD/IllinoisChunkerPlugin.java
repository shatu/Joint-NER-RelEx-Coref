...
public class IllinoisChunkerPlugin extends Annotator {
	
	private AnnotatorService annotator;
	
	public IllinoisChunkerPlugin () throws Exception {
		this(CCM2Constants.IllinoisChunkerMD, new String[]{});
	}
	
	private IllinoisChunkerPlugin(String viewName, String[] requiredViews) throws Exception {
