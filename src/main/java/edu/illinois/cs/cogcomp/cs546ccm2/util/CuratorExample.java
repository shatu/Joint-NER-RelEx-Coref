...
public class CuratorExample {
	...
	public static void main(String[] args) throws Exception {
		CreateTestTAResource();
	}
	
    public static void CreateTestTAResource() {
...
//            fos.close();
	...
	private static void getTextAnnotations() throws Exception {
        ...
        for (String text : testInputs) {
            ...
            annotator.addView(ta, ViewNames.WIKIFIER);
...
//            annotator.addView(ta, ViewNames.QUANTITIES);
	  ...
	  private static void populateTestInputs() {
