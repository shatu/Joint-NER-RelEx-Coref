...
//	
//	public LocalTrainedRelExWrapper(String md, String modelPath) throws IOException, ClassNotFoundException {
//		relEx = new LocalTrainedRelEx(md, modelPath);
//		NAME = relEx.getName();
//	}
//	
//	@Override
...
//	}
//	
//	public List<HashSet<Annotation>> getRelTagList(ACEDatasetWrapper ds) throws Exception {
...
//				docAnnots = ta.getTa().getView(relEx.getName()).getConstituents();
//				
//				for(Constituent cons: docAnnots) {
//					if(cons.getLabel().equalsIgnoreCase("NO-REL"))
//						continue;
